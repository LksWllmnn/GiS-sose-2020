...
(function (A07) {
    ...
    A07.einkUms = 0;
    for (let i = 0; i < A07.list.length; i++) {
        if (A07.list[i].kathegorie == "Soziales") {
            const großVater = document.getElementById("soziales");
            A07.list[i].div_erstellen("soziales", i, großVater);
        }
        if (A07.list[i].kathegorie == "Technik") {
            const großVater = document.getElementById("technik");
            A07.list[i].div_erstellen("technik", i, großVater);
        }
        if (A07.list[i].kathegorie == "eine Person") {
            const großVater = document.getElementById("person");
            A07.list[i].div_erstellen("person", i, großVater);
        }
        if (A07.list[i].kathegorie == "mehrere Personen") {
            const großVater = document.getElementById("personen");
            A07.list[i].div_erstellen("personen", i, großVater);
        }
    }
    //A06 Teil 2
    ...
    function hndl_showAll(_event) {
        for (let i = 0; i < A07.list.length; i++)
            A07.list[i].hndl_Hide("alle sind da...jipieieieie!!");
    }
    //A07 Teilaufgabe 2
